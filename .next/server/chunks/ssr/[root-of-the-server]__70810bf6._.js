    ...
    const onSubmit = async (values)=>{
        startTransition(async ()=>{
            try {
                ...
                // For now, we'll just show the outline in a toast.
                // In the next step, we'll save this to a file.
                toast({
                    title: 'Tool Outline Generated',
                ...
                console.error('Failed to generate tool outline:', error);
                toast({
                    variant: 'destructive',
                    title: 'Error',
                    description: 'Failed to generate tool outline. Please try again.'
                });
            }
        });
    };
...
//# sourceMappingURL=%5Broot-of-the-server%5D__70810bf6._.js.map