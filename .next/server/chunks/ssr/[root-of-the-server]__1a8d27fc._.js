...
{
/* __next_internal_action_entry_do_not_use__ [{"400fa11fd1f6abaa87ad5b953941701e45eefdf451":"deleteTool","40c808ee704c0885a587cc5fac5ea72d6ee681ccd9":"saveTool","782e9318771674b2612187883aa35a0f1b26e216e9":"updatePanelContent"},"",""] */ __turbopack_context__.s({
...
async function saveTool(toolJSON) {
    try {
        ...
        if (tools.some((tool)=>tool.id === newTool.id)) {
            // If you want to overwrite, you would find the index and replace.
            // For now, let's just prevent duplicates to be safe.
...
async function updatePanelContent(toolId, tabId, panelId, newContent) {
    try {
        ...
        // We can only update custom tools, not default tools
...
async function deleteTool(toolId) {
    try {
        ...
        await writeCustomTools(tools);
        // Revalidate the layout to update the sidebar
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["revalidatePath"])('/', 'layout');
        return {
            success: true
        };
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1a8d27fc._.js.map