...
document.addEventListener('DOMContentLoaded', function() {
    ...
    navLinks.forEach(link => {
        if (
            ...
            (link.getAttribute('href') === 'index.html' && (window.location.pathname === '/' || window.location.pathname.endsWith('/index.html')))
        ) {
    ...
    const startProjectBtn = document.querySelector('.cta-btn, .start-project-btn, #start-project-btn');
    // Only attach if this is the Forge page or a page with a start-project button
    if (startProjectBtn && (document.title.includes('Forge') || document.title.includes('My Projects'))) {
